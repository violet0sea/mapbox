...
require('./fadeFromCenterHorizontal.css')

class FadeFromCenterHorizontal extends Component{
    constructor(props) {
        super(props);
    ...
    render(){
        return(
            <div id = 'fadeFromCenterHorizontal' className = 'fadeContainer'>
...
export default FadeFromCenterHorizontal
