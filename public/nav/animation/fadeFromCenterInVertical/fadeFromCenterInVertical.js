...
require('./fadeFromCenterInVertical.css')

class FadeFromCenterInVertical extends Component{
    constructor(props) {
        super(props);
    ...
    render(){
        return(
            <div id = 'fadeFromCenterInVertical' className = 'fadeContainer'>
                <div className = 'backgroundContainer'>
                    <div className = 'background theAnimation'>
                        <div> </div>
                     </div>
                 </div>
...
export default FadeFromCenterInVertical
